...
The tab also offers a **Budget Spread** option. Choose a month and compare the planned budget to the actual spend for each category. View the distribution as a pie chart or switch to a bar chart.
